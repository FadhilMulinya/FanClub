...
interface IMintEscrow {
    ...
    struct MintIntent {
        ...
        bytes32 countryCode;       // ISO country code ( "KES")
     ...
     */
    function setComplianceManager(address _complianceManager) external;
     ...
     */
    function setCountryToken(address token) external;
